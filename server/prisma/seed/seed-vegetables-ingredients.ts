...
export async function seedVegetablesIngredients() {
    console.log("Seeding Spices(Dry) ingredients from CSV...");

    try {
        // Read CSV file
        const csvFilePath = path.resolve(__dirname, "../../data/IngredientsVegetables.csv");
        ...
        if (!category) {
            console.error("Category 'Vegetables' not found. Please run category seeding first.");
            return [];
        }
            ...
            try {
                ...
                const ingredient = await prisma.ingredient.create({
                    data: {
                        ...
                        shelfLifeDays: 7, // Default 1 week for spices
